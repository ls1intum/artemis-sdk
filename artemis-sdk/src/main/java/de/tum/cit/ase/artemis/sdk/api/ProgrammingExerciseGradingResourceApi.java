...
public class ProgrammingExerciseGradingResourceApi {
  ...
  public ApiResponse<ProgrammingExerciseGradingStatisticsDTO> getGradingStatisticsWithHttpInfo(Long exerciseId) throws ApiException {
    ...
    return apiClient.invokeAPI("ProgrammingExerciseGradingResourceApi.getGradingStatistics", localVarPath, "GET", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<Integer> reEvaluateGradedResultsWithHttpInfo(Long exerciseId) throws ApiException {
    ...
    return apiClient.invokeAPI("ProgrammingExerciseGradingResourceApi.reEvaluateGradedResults", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
