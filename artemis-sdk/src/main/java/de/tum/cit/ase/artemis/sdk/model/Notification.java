...
@JsonPropertyOrder({
  ...
  Notification.JSON_PROPERTY_TEXT_IS_PLACEHOLDER,
  Notification.JSON_PROPERTY_PLACEHOLDER_VALUES,
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ConversationNotification.class, name = "ConversationNotification"),
...
public class Notification {
  ...
  public static final String JSON_PROPERTY_TEXT_IS_PLACEHOLDER = "textIsPlaceholder";
  ...
  **/
  ...
  public Notification textIsPlaceholder(Boolean textIsPlaceholder) {
    this.textIsPlaceholder = textIsPlaceholder;
    return this;
  }

   /**
   * Get textIsPlaceholder
   * @return textIsPlaceholder
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TEXT_IS_PLACEHOLDER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public Notification placeholderValues(String placeholderValues) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, notification.id) &&
        ...
        Objects.equals(this.textIsPlaceholder, notification.textIsPlaceholder) &&
        Objects.equals(this.placeholderValues, notification.placeholderValues) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, title, text, textIsPlaceholder, placeholderValues, notificationDate, target, priority, outdated, author, targetTransient, transientAndStringTarget, notificationType);
  }
  ...
  public String toString() {
    ...
    sb.append("    textIsPlaceholder: ").append(toIndentedString(textIsPlaceholder)).append("\n");
