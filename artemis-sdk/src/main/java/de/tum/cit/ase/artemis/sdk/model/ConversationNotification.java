 ...
 */
@JsonPropertyOrder({
  ConversationNotification.JSON_PROPERTY_MESSAGE,
  ConversationNotification.JSON_PROPERTY_CONVERSATION,
  ConversationNotification.JSON_PROPERTY_TOPIC
})
...
public class ConversationNotification extends Notification {
  ...
  public ConversationNotification message(Post message) {
  ...
  **/
  ...
  public ConversationNotification conversation(Conversation conversation) {
  ...
  **/
  ...
  public ConversationNotification topic(String topic) {
    this.topic = topic;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, conversationNotification.message) &&
        Objects.equals(this.conversation, conversationNotification.conversation) &&
        Objects.equals(this.topic, conversationNotification.topic) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, conversation, topic, super.hashCode());
  }
  ...
  static {
    ...
    JSON.registerDiscriminator(ConversationNotification.class, "notificationType", mappings);
  }
}
