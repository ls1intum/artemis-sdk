 ...
 */
@JsonPropertyOrder({
  OneToOneChatDTO.JSON_PROPERTY_MEMBERS
})
...
public class OneToOneChatDTO extends ConversationDTO {
  ...
  **/
  ...
  /**
   * Return true if this OneToOneChatDTO object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(OneToOneChatDTO.class, "type", mappings);
}
}
