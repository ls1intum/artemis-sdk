 ...
 */
@JsonPropertyOrder({
  PlagiarismResultObject.JSON_PROPERTY_ID,
  PlagiarismResultObject.JSON_PROPERTY_CREATED_DATE,
  PlagiarismResultObject.JSON_PROPERTY_COMPARISONS,
  PlagiarismResultObject.JSON_PROPERTY_DURATION,
  PlagiarismResultObject.JSON_PROPERTY_EXERCISE,
  PlagiarismResultObject.JSON_PROPERTY_SIMILARITY_DISTRIBUTION,
  PlagiarismResultObject.JSON_PROPERTY_TYPE
})
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ModelingPlagiarismResult.class, name = "ModelingPlagiarismResult"),
...
public class PlagiarismResultObject {
  ...
  **/
  ...
  public PlagiarismResultObject createdDate(OffsetDateTime createdDate) {
  ...
  **/
  ...
  /**
   * Return true if this PlagiarismResultObject object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, plagiarismResultObject.id) &&
        Objects.equals(this.createdDate, plagiarismResultObject.createdDate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdDate, comparisons, duration, exercise, similarityDistribution, type);
  }
  ...
  static {
    ...
    mappings.put("PlagiarismResultObject", PlagiarismResultObject.class);
    JSON.registerDiscriminator(PlagiarismResultObject.class, "type", mappings);
  }
}
