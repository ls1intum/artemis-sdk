...
public class SearchResultPageDTOProgrammingExercise {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchResultPageDTOProgrammingExercise
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResultPageDTOProgrammingExercise.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultPageDTOProgrammingExercise is not found in the empty JSON string", SearchResultPageDTOProgrammingExercise.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SearchResultPageDTOProgrammingExercise.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultPageDTOProgrammingExercise` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("resultsOnPage") != null && !jsonObj.get("resultsOnPage").isJsonNull()) {
        ...
        if (jsonArrayresultsOnPage != null) {
          ...
          for (int i = 0; i < jsonArrayresultsOnPage.size(); i++) {
            ProgrammingExercise.validateJsonObject(jsonArrayresultsOnPage.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultPageDTOProgrammingExercise.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultPageDTOProgrammingExercise' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultPageDTOProgrammingExercise> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultPageDTOProgrammingExercise.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultPageDTOProgrammingExercise>() {
           @Override
           public void write(JsonWriter out, SearchResultPageDTOProgrammingExercise value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultPageDTOProgrammingExercise read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SearchResultPageDTOProgrammingExercise given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchResultPageDTOProgrammingExercise
  * @throws IOException if the JSON string is invalid with respect to SearchResultPageDTOProgrammingExercise
  */
  public static SearchResultPageDTOProgrammingExercise fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultPageDTOProgrammingExercise.class);
  }

 /**
  * Convert an instance of SearchResultPageDTOProgrammingExercise to an JSON string
  *
  * @return JSON string
  */
