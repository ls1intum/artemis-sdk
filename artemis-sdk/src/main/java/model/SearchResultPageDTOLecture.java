...
public class SearchResultPageDTOLecture {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchResultPageDTOLecture
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResultPageDTOLecture.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultPageDTOLecture is not found in the empty JSON string", SearchResultPageDTOLecture.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SearchResultPageDTOLecture.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultPageDTOLecture` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("resultsOnPage") != null && !jsonObj.get("resultsOnPage").isJsonNull()) {
        ...
        if (jsonArrayresultsOnPage != null) {
          ...
          for (int i = 0; i < jsonArrayresultsOnPage.size(); i++) {
            Lecture.validateJsonObject(jsonArrayresultsOnPage.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultPageDTOLecture.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultPageDTOLecture' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultPageDTOLecture> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultPageDTOLecture.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultPageDTOLecture>() {
           @Override
           public void write(JsonWriter out, SearchResultPageDTOLecture value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultPageDTOLecture read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SearchResultPageDTOLecture given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchResultPageDTOLecture
  * @throws IOException if the JSON string is invalid with respect to SearchResultPageDTOLecture
  */
  public static SearchResultPageDTOLecture fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultPageDTOLecture.class);
  }

 /**
  * Convert an instance of SearchResultPageDTOLecture to an JSON string
  *
  * @return JSON string
  */
