...
public class SearchResultPageDTOLearningGoal {
  ...
  private List<LearningGoal> resultsOnPage = new ArrayList<>();
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchResultPageDTOLearningGoal
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResultPageDTOLearningGoal.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultPageDTOLearningGoal is not found in the empty JSON string", SearchResultPageDTOLearningGoal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SearchResultPageDTOLearningGoal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultPageDTOLearningGoal` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("resultsOnPage") != null && !jsonObj.get("resultsOnPage").isJsonNull()) {
        ...
        if (jsonArrayresultsOnPage != null) {
          ...
          for (int i = 0; i < jsonArrayresultsOnPage.size(); i++) {
            LearningGoal.validateJsonObject(jsonArrayresultsOnPage.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultPageDTOLearningGoal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultPageDTOLearningGoal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultPageDTOLearningGoal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultPageDTOLearningGoal.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultPageDTOLearningGoal>() {
           @Override
           public void write(JsonWriter out, SearchResultPageDTOLearningGoal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultPageDTOLearningGoal read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SearchResultPageDTOLearningGoal given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchResultPageDTOLearningGoal
  * @throws IOException if the JSON string is invalid with respect to SearchResultPageDTOLearningGoal
  */
  public static SearchResultPageDTOLearningGoal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultPageDTOLearningGoal.class);
  }

 /**
  * Convert an instance of SearchResultPageDTOLearningGoal to an JSON string
  *
  * @return JSON string
  */
