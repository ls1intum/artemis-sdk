...
public class ManagedUserVM {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ManagedUserVM
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ManagedUserVM.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedUserVM is not found in the empty JSON string", ManagedUserVM.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ManagedUserVM.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedUserVM` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ManagedUserVM.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedUserVM.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedUserVM' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedUserVM> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedUserVM.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedUserVM>() {
           @Override
           public void write(JsonWriter out, ManagedUserVM value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedUserVM read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagedUserVM given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagedUserVM
  * @throws IOException if the JSON string is invalid with respect to ManagedUserVM
  */
  public static ManagedUserVM fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedUserVM.class);
  }

 /**
  * Convert an instance of ManagedUserVM to an JSON string
  *
  * @return JSON string
  */
