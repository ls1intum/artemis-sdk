...
public class SearchResultPageDTOModelingExercise {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchResultPageDTOModelingExercise
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResultPageDTOModelingExercise.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultPageDTOModelingExercise is not found in the empty JSON string", SearchResultPageDTOModelingExercise.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SearchResultPageDTOModelingExercise.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultPageDTOModelingExercise` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("resultsOnPage") != null && !jsonObj.get("resultsOnPage").isJsonNull()) {
        ...
        if (jsonArrayresultsOnPage != null) {
          ...
          for (int i = 0; i < jsonArrayresultsOnPage.size(); i++) {
            ModelingExercise.validateJsonObject(jsonArrayresultsOnPage.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultPageDTOModelingExercise.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultPageDTOModelingExercise' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultPageDTOModelingExercise> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultPageDTOModelingExercise.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultPageDTOModelingExercise>() {
           @Override
           public void write(JsonWriter out, SearchResultPageDTOModelingExercise value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultPageDTOModelingExercise read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SearchResultPageDTOModelingExercise given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchResultPageDTOModelingExercise
  * @throws IOException if the JSON string is invalid with respect to SearchResultPageDTOModelingExercise
  */
  public static SearchResultPageDTOModelingExercise fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultPageDTOModelingExercise.class);
  }

 /**
  * Convert an instance of SearchResultPageDTOModelingExercise to an JSON string
  *
  * @return JSON string
  */
