...
public class CodeHint extends ExerciseHint {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CodeHint
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CodeHint.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeHint is not found in the empty JSON string", CodeHint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CodeHint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeHint` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodeHint.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeHint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeHint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodeHint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodeHint.class));

       return (TypeAdapter<T>) new TypeAdapter<CodeHint>() {
           @Override
           public void write(JsonWriter out, CodeHint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodeHint read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CodeHint given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CodeHint
  * @throws IOException if the JSON string is invalid with respect to CodeHint
  */
  public static CodeHint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodeHint.class);
  }

 /**
  * Convert an instance of CodeHint to an JSON string
  *
  * @return JSON string
  */
