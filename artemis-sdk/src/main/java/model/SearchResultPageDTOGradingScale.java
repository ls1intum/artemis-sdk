...
public class SearchResultPageDTOGradingScale {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchResultPageDTOGradingScale
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResultPageDTOGradingScale.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResultPageDTOGradingScale is not found in the empty JSON string", SearchResultPageDTOGradingScale.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SearchResultPageDTOGradingScale.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResultPageDTOGradingScale` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("resultsOnPage") != null && !jsonObj.get("resultsOnPage").isJsonNull()) {
        ...
        if (jsonArrayresultsOnPage != null) {
          ...
          for (int i = 0; i < jsonArrayresultsOnPage.size(); i++) {
            GradingScale.validateJsonObject(jsonArrayresultsOnPage.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultPageDTOGradingScale.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultPageDTOGradingScale' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultPageDTOGradingScale> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultPageDTOGradingScale.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultPageDTOGradingScale>() {
           @Override
           public void write(JsonWriter out, SearchResultPageDTOGradingScale value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultPageDTOGradingScale read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SearchResultPageDTOGradingScale given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchResultPageDTOGradingScale
  * @throws IOException if the JSON string is invalid with respect to SearchResultPageDTOGradingScale
  */
  public static SearchResultPageDTOGradingScale fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultPageDTOGradingScale.class);
  }

 /**
  * Convert an instance of SearchResultPageDTOGradingScale to an JSON string
  *
  * @return JSON string
  */
